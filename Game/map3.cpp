...
int map3::mapDraw(int* x, int* y, int *c, int *d) {
	system("CLS");
	hero character;
	int k, a = 1, b = 17, l, flag = 0, enemy=35;
	int torpedo = 11;
	bossX = new int[11];
	bossY = new int[11];
	for (k = 0; k < 11; k++) {
	...
	for (k = 0; k < MAP_WIDTH; k++)
		std::cout << "O";
	setColor(RED);
	locate(x[0], y[0]); std::cout << "X";
	locate(x[1], y[1]); std::cout << "X";
	locate(x[2], y[2]); std::cout << "X";
	locate(x[3], y[3]); std::cout << "X";
	locate(x[4], y[4]); std::cout << "X";
	locate(x[5], y[5]); std::cout << "X";
	locate(x[6], y[6]); std::cout << "X";
	locate(x[7], y[7]); std::cout << "X";
	locate(x[8], y[8]); std::cout << "X";
	locate(x[9], y[9]); std::cout << "X";
	locate(x[10], y[10]); std::cout << "X";
	locate(x[11], y[11]); std::cout << "X";
	locate(x[12], y[12]); std::cout << "X";
	locate(x[13], y[13]); std::cout << "X";
	locate(x[14], y[14]); std::cout << "X";
	locate(x[15], y[15]); std::cout << "X";
	locate(x[16], y[16]); std::cout << "X";
	locate(x[17], y[17]); std::cout << "X";
	locate(x[18], y[18]); std::cout << "X";
	locate(x[19], y[19]); std::cout << "X";
	locate(x[20], y[20]); std::cout << "X";
	locate(x[21], y[21]); std::cout << "X";
	locate(x[22], y[22]); std::cout << "X";
	locate(x[23], y[23]); std::cout << "X";
	locate(x[24], y[24]); std::cout << "X";
	locate(x[25], y[25]); std::cout << "X";
	locate(x[26], y[26]); std::cout << "X";
	locate(x[27], y[27]); std::cout << "X";
	locate(x[28], y[28]); std::cout << "X";
	locate(x[29], y[29]); std::cout << "X";
	locate(x[30], y[30]); std::cout << "X";
	locate(x[31], y[31]); std::cout << "X";
	locate(x[32], y[32]); std::cout << "X";
	locate(x[33], y[33]); std::cout << "X";
	locate(x[34], y[34]); std::cout << "X";
